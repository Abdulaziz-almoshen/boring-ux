...
- **Qwen3-VL 8B Instruct** (via Ollama) — Apache 2.0. Reads the screen recording locally so findings can name the interface element a participant clicked or read.
