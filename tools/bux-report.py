...
MOMENT_COLOR = {"SEARCHING": "#e8871e", "CONFUSION": "#d33", "FRUSTRATION": "#8b0000", "LOOK_AWAY": "#9aa3b5", "FOUND_THEN_ACTED": "#0a9d54", "MISS_THEN_CORRECT": "#b06f00"}
...
def build(session, product):
    ...
    for m in M:
        if m["type"] in ("LOOK_AWAY", "SEARCHING", "CONFUSION"):
    ...
    intent = []
    for typ in ("SEARCHING", "CONFUSION", "FOUND_THEN_ACTED", "MISS_THEN_CORRECT", "FRUSTRATION", "LOOK_AWAY"):
